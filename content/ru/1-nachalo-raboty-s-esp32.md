...
[Инструкция для Windows](2-ustanovka-platy-esp-32-v-arduino-ide-na-windows)

[Инструкция для Mac and Linux](3-ustanovka-platy-esp32-v-arduino-ide-na-mac-os-x-i-linux)
...
[Распиновка ESP32: Какие GPIO пины следует использовать?](4-raspinovka-esp32)
...
[**Важно!**]{.not-prose.!text-red-500}&#x20;Всегда проверяйте распиновку вашей платы перед подключением.
