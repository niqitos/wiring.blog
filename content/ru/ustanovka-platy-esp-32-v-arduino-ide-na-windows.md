...
2. Введите \`<<[https://dl.espressif.com/dl/package\_esp32\_index.json\&#x60\&#x3E\&#x3E](/en&#x29;;;; в поле **«Additional Board Manager URLs»**, как показано на рисунке ниже. Затем нажмите кнопку **«ОК»**:
...
Устранение проблемам во время установки
