...
2. Введите \`<https://dl.espressif.com/dl/package_esp32_index.json&#x60&#x3E;; в поле **«Additional Board Manager URLs»**, как показано на рисунке ниже. Затем нажмите кнопку **«ОК»**:
