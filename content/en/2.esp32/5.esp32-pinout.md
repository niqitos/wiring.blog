...
| **6**    | `✕`{color="error"} ​​                             | `✕`{color="error"}      | connected to on-chip SPI flash                                               |
| **7**    | `✕`{color="error"} ​​                             | `✕`{color="error"}      | connected to on-chip SPI flash                                               |
| **8**    | `✕`{color="error"} ​​                             | `✕`{color="error"}      | connected to on-chip SPI flash                                               |
| **9**    | `✕`{color="error"} ​​                             | `✕`{color="error"}      | connected to on-board SPI flash                                              |
| **10**   | `✕`{color="error"} ​​                             | `✕`{color="error"}      | connected to on-board SPI flash                                              |
| **11**   | `✕`{color="error"} ​​                             | `✕`{color="error"}      | connected to on-board SPI flash                                              |
