...
links:
  - type: arduino
    to: https://app.arduino.cc/sketches/1ae8e921-e221-46ed-b021-7c86c25c2207?view-mode=preview
...
target: _blank
to: en/esp32/installing-esp32-board-in-arduino-ide-on-windows
ui:
  icon: '!text-windows'
---
...
target: _blank
to: en/esp32/installing-esp32-board-in-arduino-ide-on-mac-os
ui:
...
target: _blank
to: en/esp32/installing-esp32-board-in-arduino-ide-on-linux
ui:
  icon: '!text-black dark:!text-white'
---
...
<!-- ::cirkit-designer
---
src: https://app.cirkitdesigner.com/project/80826908-a132-4ea2-bc02-fed6f42ea3f7
---
:: -->

::nuxt-img
---
src: "/images/esp32/1/esp32-blinking-led-circuit.svg"
alt: "ESP32 Blinking Led"
class: 'bg-elevated'
---
::

1. Go to the `Tools` :chevron-right `Board` menu. Find the ESP32 section and select your ESP32 board, for example ESP32 DEVKIT V1.
2. In the `Tools` :chevron-right `Port` menu, select the port to which the ESP32 is connected. If you are not sure of the port name, disconnect the board and check which port has disappeared from the list.
3. Click `Upload`.
